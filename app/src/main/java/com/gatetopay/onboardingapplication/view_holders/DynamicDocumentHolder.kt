 ...
 * SEDRA
 */
class DynamicDocumentHolder(val view: View , val listener: FileUploadListener) : BaseHolder(view) {
       ...
       when(t){
           is DynamicFieldsItem -> {
               ...
               btnDate.setOnClickListener{
                  ...
                  listener.onSelectFileClicked(getAdapterPosition(),dynamicFieldsItem?.id?.toString()?:"0")
...
interface FileUploadListener{
    fun onSelectFileClicked(position: Int,code: String)
}
