...
class ProductsArrayAdapter(context: Context, var items: List<GetProductsResponseItem>) :
    ArrayAdapter<GetProductsResponseItem>(context, R.layout.spinner_item, items) {
